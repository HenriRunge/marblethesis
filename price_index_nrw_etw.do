...
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_full_control.pdf", replace
...
twoway ///
    ...
    legend(order(1 "NRW" 2 "Hesse" 3 "Baden-Württemberg" 4 "Bavaria" 5 "Saxony" 6 "Thuringia" 7 "Brandenburg" 8 "Schleswig-Holstein" 9 "Berlin" 10 "Hamburg") position(11) ring(0) cols(2) size(small)) ytitle("Ln(price/sqm) index (2021q4 = 1)", size(small)) xtitle("Quarter", size(small)) xline(247, lpattern(dash) lcolor(black)) xline(252, lpattern(dash) lcolor(black)) text(1.1 245 "2021q4", size(small)) text(1.1 250 "2023q2", size(small))
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_comparison.pdf", replace
...
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_comparison_reduced.pdf", replace
    ...
    legend(order(1 "Münster" 2 "Bocholt" 3 "Köln" 4 "Duisburg" 5 "Dortmund" 6 "REK" 7 "Bonn" 8 "Düsseldorf" 9 "Kreis Mettmann") position(4) ring(0) cols(3) size(small)) ytitle("Ln(price/sqm) index (2021q4 = 1)", size(small)) xtitle("Quarter", size(small)) xline(247, lpattern(dash) lcolor(black)) xline(252, lpattern(dash) lcolor(black)) text(0.95 245 "2021q4", size(small)) text(0.95 250 "2023q2", size(small))
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_comparison_cities.pdf", replace
...
*Plot the two indices
twoway (line price_nrw year_quarter, mcolor(blue) msymbol(o)) (line price_other year_quarter, mcolor(red) msymbol(x)), legend(label(1 "NRW") label(2 "Other states") position(6) ring(0) cols(1) size(small)) ytitle("Ln(price/sqm) index (2021q4 = 1)", size(small)) xtitle("Quarter", size(small)) xline(247, lpattern(dash) lcolor(black)) xline(252, lpattern(dash) lcolor(black)) text(0.95 245 "2021q4", size(small)) text(0.95 250 "2023q2", size(small))
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_reduced_control_w_Hamburg.pdf", replace
...
*Plot the two indices
twoway (line price_nrw year_quarter, mcolor(blue) msymbol(o)) (line price_other year_quarter, mcolor(red) msymbol(x)), legend(label(1 "NRW") label(2 "Other states") position(6) ring(0) cols(1) size(small)) ytitle("Ln(price/sqm) index (2021q4 = 1)", size(small)) xtitle("Quarter", size(small)) xline(247, lpattern(dash) lcolor(black)) xline(252, lpattern(dash) lcolor(black)) text(0.95 245 "2021q4", size(small)) text(0.95 250 "2023q2", size(small))
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_nrw_etw_reduced_control_wo_Hamburg.pdf", replace
