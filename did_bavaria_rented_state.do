...
reghdfe ln_price treat_intro_m* area_living area_living_sq i.location_quality_num i.construction_year_cat_num new_build unrented, absorb(district_num_new year_quarter) vce(cluster bundesland) 
...
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\coeffplot_bavaria_rented_state.pdf", replace
...
*Export-------------------------------------------------------------------------
esttab model1 using bavaria_results_state.tex, ///
	replace booktabs ///
