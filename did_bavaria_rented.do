...
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\coeffplot_bavaria_rented_correct.pdf", replace
...
*Export-------------------------------------------------------------------------
esttab model1 using bavaria_results_2.tex, ///
	replace booktabs ///
