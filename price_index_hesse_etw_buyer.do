...
*drop if city == "Wiesbaden"
    ...
    * Compute mean price per rentstatus and half
    collapse (mean) mean_price = ln_price_sq, by(buyer_type_dummy year_half)
    ...
    * Graph
    twoway (line price_index year_half if buyer_type_dummy == 1, mcolor(blue) msymbol(o)) ///
           (line price_index year_half if buyer_type_dummy == 0, mcolor(red) msymbol(x)), ///
...
graph export "C:\Users\greix-hiwi-04\Nextcloud\Henri_real_estate_tax\price_index_hesse_etw_buyer.pdf", replace
